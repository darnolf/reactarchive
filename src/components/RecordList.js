   ...
   <tbody>
     {
       this.state.records.length === 0 ? (
           ...
           this.state.records.map(({ id: ID, STN, DDMMYY, FROM_T, TO_T, TTL, CHP, TIME_LC, DIG, TEXT,tags,unixTime,rowID, ...props}) => {
            ...
            const timelinecalc = () => {
             ...
             return (
              <tr key={ID+'key'} data-index={ID}>
                 ...
                 <td className="text-center"><small>{rowID}</small></td>
                 <td className="nowrap text-center">{dateformatted()}</td>
                 <td className="text-center">{FROM_T}</td>
                 <td className="text-center">{TO_T}</td>
                 <td className="text-center">{TTL}</td>
                 <td className="text-center">{CHP}</td>
                 <td className="text-center">{TIME_LC}</td>
                 <td className="text-center">{timelinecalc()}</td>
                 <td className="text-center">{DIG}</td>
                 ...
                 <td className="text-center"><Link className="btn btn-outline-dark btn-sm" to={`/edit/${ID}`}><FontAwesome.FaEdit /></Link></td>
                </tr>
             )
           })
         )
